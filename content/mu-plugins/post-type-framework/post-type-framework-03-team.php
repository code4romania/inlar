<?php
/**
 * Post Type Framework: Team
 */

class Post_Type_Team extends Post_Type_Framework {
	...
	function setup() {
		...
		$this->post_type_name = 'team';
		$this->post_type_args = array(
			'labels'              => array(
				'name'               => __('Team members', 'ptf'),
				'singular_name'      => __('Team member', 'ptf'),
				'add_new'            => __('Add New', 'ptf'),
				'add_new_item'       => __('Add Team member', 'ptf'),
				'edit_item'          => __('Edit Team member', 'ptf'),
				'all_items'          => __('All Team members', 'ptf'),
				'view_item'          => __('View Team member', 'ptf'),
				'search_items'       => __('Search Team members', 'ptf'),
				'not_found'          => __('No team members found', 'ptf'),
				'not_found_in_trash' => __('No team members found in Trash', 'ptf'),
				'menu_name'          => __('Team', 'ptf')
			),
